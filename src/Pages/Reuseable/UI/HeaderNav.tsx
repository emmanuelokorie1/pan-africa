      ...
      {noImage ? (
        <div className="flex justify-center items-center text-center">
          <div className="w-[40%] pt-[3rem]">
            <div className="text-textColor text-[1.3rem] ps-2">
              {title}
            </div>
            <div className="text-[2rem] pt-2">{headerText}</div>
            <div className="text-[.9rem] text-[#FFFFFF] pt-[1rem]">{text}</div>
          </div>
        </div>
      ) : (
        <div className="flex justify-between mt-[3rem]">
          <div className="w-[58%] ps-[8rem]">
            ...
            <div className={`text-[${size || '1.6rem'}] pt-2 font-bold`}>{headerText}</div>
            <div className="text-[.9rem] text-[#FFFFFF] pt-[1rem]">{text}</div>
            <div className="text-[.9rem] text-[#FFFFFF] pt-[1rem]">{text2}</div>
          </div>
          <div className="w-[40%]">
